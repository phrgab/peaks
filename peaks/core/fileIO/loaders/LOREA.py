...
def _load_LOREA_data(fname):
    ...
    elif "sax" in analyser_keys or "saz" in analyser_keys:
        # Assign scan type
        scan_type = "line scan"
    ...
    elif ("salong" in analyser_keys) or ("say" in analyser_keys):
        # Assign scan type
...
def _load_LOREA_metadata(fname, scan_type):
    ...
    sweep_handles = [
        "entry1/instrument/analyser/number_of_scans",
...
@_register_location
class _LoreaConventions(_BaseARPESConventions):
    loc_name = "ALBA LOREA"
    loader = _load_LOREA_data
    metadata_loader = _load_LOREA_metadata
    ana_type = "IIp"
    polar_name = "sapolar"
    tilt_name = "satilt"
    azi_name = "saazimuth"
    defl_par_name = "defl_x"
    defl_perp_name = "defl_y"
    x1_name = "sax"
    x2_name = "saz"
    x3_name = "say"
