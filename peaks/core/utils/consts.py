...
class consts(object):
    ...
    kvac_const = 0.5123167243227325  # sqrt(2m_e/hbar^2) in units for energy in eV and k in 1/AA
    ...
    reduced_Planck_const = 1.054571817 * 10 ** -34  # Reduced Planck constant in units of Js
