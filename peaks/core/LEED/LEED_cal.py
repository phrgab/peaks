...
def setAttrs(data, **kwargs): 
    ...
    if isinstance(data, xr.core.dataset.Dataset):
        ...
        if 'name' in kwargs:
            ...
            if 'theta_offset' in kwargs:
                data[name].attrs['theta_offset'] = kwargs['theta_offset']
            if 'phi_offset' in kwargs:
                data[name].attrs['phi_offset'] = kwargs['phi_offset']
...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.tabWidget.setGeometry(QtCore.QRect(0, 0, 884, 775))
        self.tabWidget.setMinimumSize(QtCore.QSize(0, 775))
        ...
        #Add the calibrate widget as the first tab
        self.tabWidget.addTab(self.calibrate, "")
        
        #----------------------------------------------------------------------
        #Second tab - centering widget
        ...
        #Make Graphics scene
        self.cen_view = QtWidgets.QGraphicsScene(self.center)
        
        #Make Graphics View so and place the scene in
        self.center_view = QtWidgets.QGraphicsView(self.cen_view, self.center)
        self.center_view.setGeometry(QtCore.QRect(0, 0, 884, 643))
        self.center_view.setObjectName("center_view")
        self.center_view.setFrameStyle(QtWidgets.QFrame.NoFrame)
        
        #Make the widget to put all buttons in (beneath the graph)
        self.gridLayoutWidget = QtWidgets.QWidget(self.center)
        self.gridLayoutWidget.setGeometry(QtCore.QRect(0, 655, 884, 97))
        self.gridLayoutWidget.setObjectName("gridLayoutWidget")
        
        #Make gridlayout to put all buttons in
        self.gridLayout_8 = QtWidgets.QGridLayout(self.gridLayoutWidget)
        self.gridLayout_8.setContentsMargins(0, 0, 0, 0)
        self.gridLayout_8.setObjectName("gridLayout_8")
        
        #Make helper instructions label
        self.instruct_cen = QtWidgets.QLabel(self.gridLayoutWidget)
        self.instruct_cen.setAlignment(QtCore.Qt.AlignCenter)
        self.instruct_cen.setFont(font)
        self.instruct_cen.setObjectName("instruct_cen")
        self.gridLayout_8.addWidget(self.instruct_cen, 0, 0, 1, 13)
        
        #Shape label
        self.shapeLabel2 = QtWidgets.QLabel(self.gridLayoutWidget)
        self.shapeLabel2.setFont(font)
        self.shapeLabel2.setObjectName("shapeLabel2")
        self.gridLayout_8.addWidget(self.shapeLabel2, 1, 0, 1, 1)
        
        #ComboBox to select shape
        self.shapeComboBox = QtWidgets.QComboBox(self.gridLayoutWidget)
        self.shapeComboBox.setObjectName("shapeComboBox")
        self.shapeComboBox.addItem("Hexagon")
        self.shapeComboBox.addItem("Square")
        self.shapeComboBox.addItem("Rectangle")
        self.shapeComboBox.setFont(font)
        self.gridLayout_8.addWidget(self.shapeComboBox, 1, 1, 1, 1)
        
        #Spacer item next to filename combo
        spacerItem4 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_8.addItem(spacerItem4, 1, 2, 1, 1)
        
        #Clear button
        self.Clear2 = QtWidgets.QPushButton(self.gridLayoutWidget)
        self.Clear2.setFont(font)
        self.Clear2.setObjectName("Clear2")
        self.gridLayout_8.addWidget(self.Clear2, 1, 3, 1, 1)
        
        #Spacer next to clear button
        spacerItem5 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_8.addItem(spacerItem5, 1, 4, 1, 1)
        
        #Calculate rotation disorder label
        self.disorder_label = QtWidgets.QLabel(self.gridLayoutWidget)
        self.disorder_label.setFont(font)
        self.disorder_label.setObjectName("filename_label")
        self.gridLayout_8.addWidget(self.disorder_label, 1, 5, 1, 1)
        
        #Disorder Boolean
        self.Check = QtWidgets.QCheckBox(self.gridLayoutWidget)
        self.Check.setFont(font)
        self.Check.setObjectName("Clear2")
        self.gridLayout_8.addWidget(self.Check, 1, 6, 1, 1)
        
        #Spacer next to clear button
        spacerItem7 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_8.addItem(spacerItem7, 1, 7, 1, 1)
        
        #Button to add center data
        ...
        self.gridLayout_8.addWidget(self.Add, 1, 9, 1, 1)
        
        #Spacer item in col=6
        spacerItem6 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_8.addItem(spacerItem6, 1, 10, 1, 1)
        
        #Filename label
        self.filename_label = QtWidgets.QLabel(self.gridLayoutWidget)
        self.filename_label.setFont(font)
        self.filename_label.setObjectName("filename_label")
        self.gridLayout_8.addWidget(self.filename_label, 1, 11, 1, 1)
        
        #ComboBox to select filename
        self.comboBox = QtWidgets.QComboBox(self.gridLayoutWidget)
        self.comboBox.setObjectName("comboBox")
        self.comboBox.setFont(font)
        self.gridLayout_8.addWidget(self.comboBox, 1, 12, 1, 1)
        
        #Energy label
        self.energy2 = QtWidgets.QLabel(self.gridLayoutWidget)
        self.energy2.setFont(font)
        self.energy2.setObjectName("shapeLabel2")
        self.gridLayout_8.addWidget(self.energy2, 2, 0, 1, 1)
        
        #Input box for electron energy
        self.lineEditEnergy2 = QtWidgets.QLineEdit(self.layoutWidget)
        self.lineEditEnergy2.setObjectName("lineEditEnergy2")
        self.gridLayout_8.addWidget(self.lineEditEnergy2, 2, 1, 1, 1)
        
        #Button to automate Bragg peak selection
        self.Automate2 = QtWidgets.QPushButton(self.gridLayoutWidget)
        self.Automate2.setFont(font)
        self.Automate2.setObjectName("Automate2")
        self.gridLayout_8.addWidget(self.Automate2, 2, 3, 1, 1)
        
        #A final execute button
        ...
        self.gridLayout_8.addWidget(self.Execute2, 2, 9, 1, 1)
        
        #Center all button
        self.center_all = QtWidgets.QPushButton(self.layoutWidget)
        self.center_all.setFont(font)
        self.center_all.setObjectName("center_all")
        self.gridLayout_8.addWidget(self.center_all, 2, 11, 1, 2)
        
        self.center_view.raise_()
        self.gridLayoutWidget.raise_()
        
        #Add this centering tab
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.energy2.setText(_translate("MainWindow", "Energy:"))
        ...
        self.Automate2.setText(_translate("MainWindow", "Automate"))
        self.center_all.setText(_translate("MainWindow", "Center All"))
        self.disorder_label.setText(_translate("MainWindow", "Calculate disorder")) 
        self.calibrate_center_all.setText(_translate("MainWindow","Calibrate and Center All"))
        self.shapeLabel2 .setText(_translate("MainWindow","Shape:"))
        self.offset_label.setText(_translate("MainWindow","Offset"))
        self.instruct_cen.setText(_translate("MainWindow", "Click on center of LEED, or click on the 1st Order Bragg Peaks and press add to identify center. When finished press execute"))
...
class CalibrateGUI(QtWidgets.QMainWindow):
     def __init__(self, file, xarray, app, **kwargs):
         ...
         self.combovalue = self.ui.comboBox.currentText()
         self.img = xarray[self.combo2value].data
         ...
         self.ui.cen_view = PlotWidgetSig(self.ui.center)
         self.ui.cen_view.setGeometry(QtCore.QRect(0, 0, 884, 643))
         self.ui.cen_view.viewport().setProperty("cursor", QtGui.QCursor(QtCore.Qt.CrossCursor))
         ...
         self.create_graph2(xarray[self.combovalue].data, self.ui.cen_view)
         
         self.ui.tabWidget.currentChanged.connect(self.changed)
         self.ui.Clear1.clicked.connect(self.Clear1Clicked)
         self.ui.Clear2.clicked.connect(self.Clear1Clicked)
         self.ui.Calibrate1.clicked.connect(self.ExecuteClicked)
         self.ui.Execute2.clicked.connect(self.ExecuteClicked2)
         self.ui.Automate1.clicked.connect(self.AutomateButtonClicked)
         self.ui.Automate2.clicked.connect(self.AutomateButtonClicked)
         self.ui.cal_center.clicked.connect(self.calAndCenter)
         self.ui.combo2.currentIndexChanged.connect(self.combochange)
         self.ui.comboBox.currentIndexChanged.connect(self.combochange2)
         self.ui.Add.clicked.connect(self.add)
         self.ui.center_all.clicked.connect(self.centerAll)
         ...
         self.ui.cen_view.scene().sigMouseClicked.connect(self.mouseClickEvent)
         self.ui.cal_view.sigKeyPress.connect(self.circleSizeChange)
         self.ui.cen_view.sigKeyPress.connect(self.circleSizeChange)
         ...
         if 'energy' in xarray[self.combovalue].attrs and xarray[self.combovalue].attrs['energy'] != None:
             ...
             self.ui.lineEditEnergy2.setText(str(xarray[self.combovalue2].attrs['energy']))
        ...
        if self.ui.lineEdit_3.text() == '' and self.ui.lineEditEnergy.text() == '':
            ...
            if hasattr(self, 'line'):
                ...
                if self.ui.Check2.isChecked():
                    theta_offset, phi_offset = offsets(self.img, self.moveObject, self.center, self.ui.lineEditEnergy2, self.ui.lineEdit_3)
                    self.text.append("setAttrs(data = {0}, name = '{1}', theta_offset = {2:.2f}, phi_offset = {3:.2f})".format(self.file, self.combovalue, theta_offset, phi_offset))
...
def cal_tool(xarray, *kargs, **kwargs):
    """
    ...
    **kwargs : TYPE
    ...
    if len(GUI.text) > 0:
        ...
        exec(text, {'LEED_q_convert': LEED_q_convert, 'setAttrs': setAttrs, file: xarray})
    ...
    Jupyter.notebook.get_cell(cell_idx).set_text(code2)
    """))
